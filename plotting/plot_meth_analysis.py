...
for col_str in column_strings:
    ...
    sns.boxplot(x="time", y=col_str, hue="sex", palette=["lightsteelblue", "pink"], data=plot_df, notch=False)
    sns.despine(offset=10, trim=True)
    f.savefig(f'D:\\uni\\Biologie\\Master\\Masterarbeit_NZ\\analyses\\python_analysis\\ethoVision_database\\meth_figures\\{col_str}_boxplot.svg') #Alex
